import { UserEntityDal_generated } from './dal.generated';

/**
 * Data access classes for model in typescript (nest.js) for UserEntity
 ...
 * a legal entity. this should be re-done to not include properties, rather its three derivations (UserTrust, UserCorporation and UserBeneficiary) should take its place
 */
export class UserEntityDal extends UserEntityDal_generated {
	/**
