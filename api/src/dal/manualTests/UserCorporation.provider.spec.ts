...
describe('UserCorporationDal', () => {
    let dal: UserCorporationDal;

    beforeEach(async () => {
        const app: TestingModule = await Test.createTestingModule(
            {
                providers: [...DatabaseConnectionPool, UserCorporationDal, UserEntityDal],
            }).compile();

        dal = await app.resolve<UserCorporationDal>(UserCorporationDal);
