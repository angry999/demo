import { UserTrustDal_generated } from './dal.generated';

/**
 * Data access classes for model in typescript (nest.js) for UserTrust
 ...
 * An investment entity for users trusts
 */
export class UserTrustDal extends UserTrustDal_generated {
	/**
