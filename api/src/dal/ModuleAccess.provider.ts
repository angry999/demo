import { ModuleAccessDal_generated } from './dal.generated';

/**
 * Data access classes for model in typescript (nest.js) for ModuleAccess
 ...
 * the specification of what operations one user can perform in one module
 */
export class ModuleAccessDal extends ModuleAccessDal_generated {
	/**
