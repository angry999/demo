...
/**
 * a query mutator that ensures nothing is ever returned
 */
export class NoAccessQueryMutator extends AbstractQueryMutator {
    /**
    ...
    adjustFor(query: Select, schema: string, table: string, table_alias: string, user: UserIdentification): any {
        let additionalAst = this.astifyWhereFragment('1=0');
