...
describe('ComputedProjectIncomeDal-generated', () => {
    let dal: ComputedProjectIncomeDal;
    ...
    beforeEach(async () => {
        ...
        dal = await moduleFixture.resolve<ComputedProjectIncomeDal>(ComputedProjectIncomeDal);
