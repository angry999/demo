...
describe('ProjectTaxSummaryDal-generated', () => {
    let dal: ProjectTaxSummaryDal;
    ...
    beforeEach(async () => {
        ...
        dal = await moduleFixture.resolve<ProjectTaxSummaryDal>(ProjectTaxSummaryDal);
    ...
    it('Create one then update', async () => {
        let newObject = new ProjectTaxSummary();
        ...
        newObject.xml_generated = true; // boolean boolean
        ...
        expect(savedObject.xml_generated).toBe(newObject.xml_generated);
        ...
        newObject.xml_generated = false; // boolean
        ...
        expect(reloadedObject.xml_generated).toBe(newObject.xml_generated);
