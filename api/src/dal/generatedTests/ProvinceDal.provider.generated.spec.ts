...
describe('ProvinceDal-generated', () => {
    let dal: ProvinceDal;
    ...
    beforeEach(async () => {
        ...
        dal = await moduleFixture.resolve<ProvinceDal>(ProvinceDal);
    ...
    it('Create one then update', async () => {
        ...
        newObject.code = 'abcde'; // string 
        newObject.latitude = -1; // number 
        newObject.longitude = -1; // number 
        newObject.timezone = 'abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz'; // string 
        ...
        expect(savedObject.latitude).toBe(newObject.latitude);
        expect(savedObject.longitude).toBe(newObject.longitude);
        expect(savedObject.timezone).toBe(newObject.timezone);
        ...
        newObject.code = '01234'; // string
        newObject.latitude = 1; // number
        newObject.longitude = 1; // number
        newObject.timezone = '01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmno'; // string
        ...
        expect(reloadedObject.latitude).toBe(newObject.latitude);
        expect(reloadedObject.longitude).toBe(newObject.longitude);
        expect(reloadedObject.timezone).toBe(newObject.timezone);
