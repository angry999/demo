...
describe('InvestmentWatchlistDal-generated', () => {
    ...
    beforeEach(async () => {
        ...
        dal = await moduleFixture.resolve<InvestmentWatchlistDal>(InvestmentWatchlistDal);
    ...
    it('Create one then update', async () => {
        let newObject = new InvestmentWatchlist();

        // assign value to each property
        // newObject.id = ?; // number
        // newObject.user_id = ?; // number
        // newObject.project_id = ?; // number
        newObject.at20 = true; // boolean boolean
        newObject.at40 = true; // boolean boolean
        newObject.at60 = true; // boolean boolean
        newObject.at80 = true; // boolean boolean
        newObject.at100 = true; // boolean boolean
        newObject.in_active = true; // boolean boolean
        ...
        expect(savedObject.at20).toBe(newObject.at20);
        expect(savedObject.at40).toBe(newObject.at40);
        expect(savedObject.at60).toBe(newObject.at60);
        expect(savedObject.at80).toBe(newObject.at80);
        expect(savedObject.at100).toBe(newObject.at100);
        expect(savedObject.in_active).toBe(newObject.in_active);
        expect(savedObject.is_deleted).toBe(newObject.is_deleted);

        // update save and compare
        newObject.id = newObjectId as number;
        newObject.at20 = false; // boolean
        newObject.at40 = false; // boolean
        newObject.at60 = false; // boolean
        newObject.at80 = false; // boolean
        newObject.at100 = false; // boolean
        newObject.in_active = false; // boolean
        ...
        // compare the two objects
        expect(reloadedObject.at20).toBe(newObject.at20);
        expect(reloadedObject.at40).toBe(newObject.at40);
        expect(reloadedObject.at60).toBe(newObject.at60);
        expect(reloadedObject.at80).toBe(newObject.at80);
        expect(reloadedObject.at100).toBe(newObject.at100);
        expect(reloadedObject.in_active).toBe(newObject.in_active);
