...
describe('ProjectPdfDal-generated', () => {
    ...
    beforeEach(async () => {
        ...
        dal = await moduleFixture.resolve<ProjectPdfDal>(ProjectPdfDal);
    ...
    it('Create one then update', async () => {
        ...
        newObject.filename = ''; // string 
        ...
        expect(savedObject.filename).toBe(newObject.filename);
        ...
        newObject.filename = ''; // string
        ...
        expect(reloadedObject.filename).toBe(newObject.filename);
