...
describe('ProjectKeybackerDal-generated', () => {
    ...
    beforeEach(async () => {
        ...
        dal = await moduleFixture.resolve<ProjectKeybackerDal>(ProjectKeybackerDal);
    ...
    it('Create one then update', async () => {
        let newObject = new ProjectKeybacker();

        // assign value to each property
        // newObject.id = ?; // number
        // newObject.project_id = ?; // number
        // newObject.project_entity_id = ?; // number
        newObject.name = 'abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmno'; // string 
        newObject.type = 'abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz'; // string 
        ...
        newObject.work = 'abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz'; // string 
        newObject.info = ''; // string 
        ...
        expect(savedObject.type).toBe(newObject.type);
        expect(savedObject.city).toBe(newObject.city);
        expect(savedObject.work).toBe(newObject.work);
        expect(savedObject.info).toBe(newObject.info);
        ...
        newObject.name = '01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcd'; // string
        newObject.type = '01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmno'; // string
        ...
        newObject.work = '01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmnopqrstuvwxyz01234567890abcdefghijklmno'; // string
        newObject.info = ''; // string
        ...
        expect(reloadedObject.type).toBe(newObject.type);
        expect(reloadedObject.city).toBe(newObject.city);
        expect(reloadedObject.work).toBe(newObject.work);
        expect(reloadedObject.info).toBe(newObject.info);
