...
describe('WebHookDal-generated', () => {
    ...
    beforeEach(async () => {
        ...
        dal = await moduleFixture.resolve<WebHookDal>(WebHookDal);
    ...
    it('Create one then update', async () => {
        let newObject = new WebHook();

        // assign value to each property
        // newObject.id = ?; // number
        newObject.event_type = 1 as unknown as EventType // enum; // EventType EventType
        newObject.url = ''; // string 
        ...
        expect((typeof savedObject.event_type == 'string') ? parseInt(savedObject.event_type) : savedObject.event_type).toBe(newObject.event_type);
        expect(savedObject.url).toBe(newObject.url);
        expect(savedObject.is_deleted).toBe(newObject.is_deleted);

        // update save and compare
        newObject.id = newObjectId as number;
        newObject.event_type = 2 as unknown as EventType // enum; // EventType
        newObject.url = ''; // string
        ...
        // compare the two objects
        expect((typeof reloadedObject.event_type == 'string') ? parseInt(reloadedObject.event_type) : reloadedObject.event_type).toBe(newObject.event_type);
        expect(reloadedObject.url).toBe(newObject.url);
