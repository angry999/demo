import { ProjectEntityDetailDal_generated } from './dal.generated';

/**
 * Data access classes for model in typescript (nest.js) for ProjectEntityDetail
 ...
 * additional specification for a project entity. the specifics are determined by what kind of entity it is
 */
export class ProjectEntityDetailDal extends ProjectEntityDetailDal_generated {
	/**
