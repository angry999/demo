import { UserRequestApi_generated } from './api.generated';

/**
 * REST API classes for model in typescript (nest.js) for UserRequest
 ...
 * a request by a user for a change to their account. this is not for customer service type requests but rathe structural ones like becoming a notable investor
 */
export class UserRequestApi extends UserRequestApi_generated {
	/**
