import { ProjectImageApi_generated } from './api.generated';

/**
 * REST API classes for model in typescript (nest.js) for ProjectImage
 ...
 * one image for one project or project entity. if project entity is filled in it for that entity otherwise its for the project
 */
export class ProjectImageApi extends ProjectImageApi_generated {
	/**
