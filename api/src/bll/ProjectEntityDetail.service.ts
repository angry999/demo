import { ProjectEntityDetailService_generated } from './bll.generated';

/**
 * Business logic (service) classes for model in typescript (nest.js) for ProjectEntityDetail
 ...
 * additional specification for a project entity. the specifics are determined by what kind of entity it is
 */
export class ProjectEntityDetailService extends ProjectEntityDetailService_generated {
	/**
