 ...
 * 
 */
class ProjectsTile extends AbstractTile {
    /**
    ...
    callApi(config: Configuration) {
        ...
        let request = { dataType: MetricDataType.project_count };
    ...
    getIcon(): JSX.Element {
        ...
        return <ApartmentIcon className={classes.titleIcon}></ApartmentIcon>
    }
    ...
    getToolTip(): string {
        return 'The total number of projects that have been created';
    }
}
ProjectsTile.contextType = UserContext;
