...
export class OrderPurchaseDateFilter extends Component<IProps, IState> {
    constructor(props: IProps) {
        ...
        let specifics = { startingOrderPurchaseDate: start, endingOrderPurchaseDate: end };
    ...
    handleSelectionChange(event: any, index: any) {
        ...
        if (this.props.onChange !== undefined) {
            let specifics = { orderPurchaseDateRange: dateRange, startingOrderPurchaseDate: start, endingOrderPurchaseDate: end };
            this.props.onChange(specifics);
        }
    }
    ...
    handleStartDateChange(date: Date | null) {
        ...
        if (this.props.onChange !== undefined) {
            let specifics = { startingOrderPurchaseDate: date, endingOrderPurchaseDate: this.state.end };
            this.props.onChange(specifics);
        }
    };
    ...
    handleEndDateChange(date: Date | null) {
        ...
        if (this.props.onChange !== undefined) {
            let specifics = { startingOrderPurchaseDate: this.state.start, endingOrderPurchaseDate: date };
            this.props.onChange(specifics);
        }
    };
